...
| RustFS | ファイルストレージ | セルフホスト / S3互換ストレージ |
...
| `MINIO_ENDPOINT` | RustFS エンドポイント | `localhost:9000` |
| `MINIO_PUBLIC_ENDPOINT` | RustFS 公開エンドポイント（開発環境でPresigned URL署名用） | `http://localhost:9002` |
