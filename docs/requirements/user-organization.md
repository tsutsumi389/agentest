...
| USR-012 | メールアドレス確認 | 登録時に確認メール送信、確認完了までログインブロック（OAuthユーザーは自動確認） |
...
| カテゴリ | イベント |
|----------|----------|
| 認証 | ログイン、ログアウト、新規登録、メールアドレス確認、パスワード変更/リセット、OAuth 連携追加/解除 |
...
| 項目 | 要件 |
|------|------|
| 認証方式 | メール/パスワード + GitHub / Google OAuth 2.0（メール確認必須） |
