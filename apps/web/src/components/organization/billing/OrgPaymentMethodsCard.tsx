...
export function OrgPaymentMethodsCard({ organizationId }: OrgPaymentMethodsCardProps) {
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(true);
    try {
      await orgBillingApi.deletePaymentMethod(organizationId, deleteTarget.id);
  ...
  const handleSetDefault = async (paymentMethodId: string) => {
    ...
    try {
      await orgBillingApi.setDefaultPaymentMethod(organizationId, paymentMethodId);
