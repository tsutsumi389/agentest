...
export const testCasesApi = {
  ...
  getPreconditions: (testCaseId: string) =>
    api.get<{ preconditions: TestCasePrecondition[] }>(
      `/api/test-cases/${testCaseId}/preconditions`
    ),
  addPrecondition: (
    testCaseId: string,
    data: { content: string; orderKey?: string; groupId?: string }
  ) =>
    api.post<{ precondition: TestCasePrecondition }>(
      `/api/test-cases/${testCaseId}/preconditions`,
      data
    ),
  updatePrecondition: (
    ...
    api.patch<{ precondition: TestCasePrecondition }>(
      `/api/test-cases/${testCaseId}/preconditions/${preconditionId}`,
      data
    ),
  ...
  reorderPreconditions: (testCaseId: string, preconditionIds: string[], groupId?: string) =>
    api.post<{ preconditions: TestCasePrecondition[] }>(
      `/api/test-cases/${testCaseId}/preconditions/reorder`,
      { preconditionIds, groupId }
    ),
  ...
  reorderSteps: (testCaseId: string, stepIds: string[], groupId?: string) =>
    api.post<{ steps: TestCaseStep[] }>(`/api/test-cases/${testCaseId}/steps/reorder`, {
      stepIds,
      groupId,
    }),
  ...
  getExpectedResults: (testCaseId: string) =>
    api.get<{ expectedResults: TestCaseExpectedResult[] }>(
      `/api/test-cases/${testCaseId}/expected-results`
    ),
  addExpectedResult: (
    testCaseId: string,
    data: { content: string; orderKey?: string; groupId?: string }
  ) =>
    api.post<{ expectedResult: TestCaseExpectedResult }>(
      `/api/test-cases/${testCaseId}/expected-results`,
      data
    ),
  updateExpectedResult: (
    ...
    api.patch<{ expectedResult: TestCaseExpectedResult }>(
      `/api/test-cases/${testCaseId}/expected-results/${expectedResultId}`,
      data
    ),
  ...
  reorderExpectedResults: (testCaseId: string, expectedResultIds: string[], groupId?: string) =>
    api.post<{ expectedResults: TestCaseExpectedResult[] }>(
      `/api/test-cases/${testCaseId}/expected-results/reorder`,
      { expectedResultIds, groupId }
    ),
