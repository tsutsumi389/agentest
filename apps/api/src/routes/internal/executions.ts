 ...
 */
router.patch(
  '/executions/:executionId/precondition-results/:preconditionResultId',
 ...
 */
router.patch(
  '/executions/:executionId/step-results/:stepResultId',
  async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
router.patch(
  '/executions/:executionId/expected-results/:expectedResultId',
  async (req: Request, res: Response, next: NextFunction) => {
    try {
 ...
 */
router.post(
  '/executions/:executionId/expected-results/:expectedResultId/evidences',
 ...
 */
router.post(
  '/executions/:executionId/expected-results/:expectedResultId/evidences/upload-url',
  async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { executionId, expectedResultId } = req.params;
 ...
 */
router.post(
  '/executions/:executionId/evidences/:evidenceId/confirm',
  async (req: Request, res: Response, next: NextFunction) => {
    try {
