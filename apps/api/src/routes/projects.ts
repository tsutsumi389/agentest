...
router.get(
  ...
  requireAuth(authConfig),
  requireProjectRole(['ADMIN', 'WRITE', 'READ']),
  projectController.getEnvironments
);
 ...
 */
router.post(
  '/:projectId/environments/reorder',
  requireAuth(authConfig),
  requireProjectRole(['ADMIN', 'WRITE']),
  projectController.reorderEnvironments
);
...
router.get(
  ...
  requireAuth(authConfig),
  requireProjectRole(['ADMIN', 'WRITE', 'READ']),
  projectController.getTestSuites
);
...
router.get(
  '/:projectId/histories',
  requireAuth(authConfig),
  requireProjectRole(['ADMIN', 'WRITE', 'READ'], { allowDeletedProject: true }),
  projectController.getHistories
);
...
router.post(
  '/:projectId/restore',
  requireAuth(authConfig),
  requireProjectRole(['ADMIN'], { allowDeletedProject: true }),
